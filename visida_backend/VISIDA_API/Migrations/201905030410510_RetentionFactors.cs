namespace VISIDA_API.Migrations
{
    ...
    public partial class RetentionFactors : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                "dbo.RetentionFactors",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Table_Id = c.Int(),
                        Name = c.String(maxLength: 256, unicode: false),
                        RetentionType = c.Int(nullable: false),
        ...
        {
            DropForeignKey("dbo.RetentionFactors", "Table_Id", "dbo.FoodCompositionTables");
            DropIndex("dbo.RetentionFactors", new[] { "Table_Id" });
            DropTable("dbo.RetentionFactors");
        }
    }
}
